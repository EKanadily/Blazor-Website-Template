...
module.exports = {
	context: path.resolve(__dirname, 'wwwroot-src/'), // __dirname is the directory of this file
	...
	plugins:
		[
			...
			,
				new WebpackShellPlugin({onBuildStart:['echo "Webpack Start"'], onBuildEnd:['compile_sass.bat']})
				,
